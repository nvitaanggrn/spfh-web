      ...
      <div class="col-9">
        <div class="card shadow-sm">
          <div class="card-body p-5">
            ...
            <div class="mb-4">
              <router-link
                :to="{path: '/admin/news', query: {category: data.category_id}}"
                class="text-muted">
                {{data.category_name}}
