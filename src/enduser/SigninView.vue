      ...
      <div class="card shadow">
        <form class="card-body" @submit.prevent>
          ...
          <div class="text-muted text-center px-5">
            <small>
              Belum mempunyai akun? <router-link to="/signup">Daftar</router-link>
            </small>
          </div>
        </form>
...
let _apiRequest = Api.createPostRequest('/enduser/user/signin')
...
#signin > div > .card > .card-body > .logo > img{
  height: 5rem;
}
</style>